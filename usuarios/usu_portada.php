                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
                                        <tr>
                                            ...
                                            <td>*******</td>
                                            <td><a class="btn btn-warning" href="<?php echo "../admin/editar.php?id=" . $row["id"]?>"><i class="fa fa-edit"></i></a></td>
				                         	<td><a class="btn btn-danger" href="<?php echo "../admin/eliminar.php?id=" . $row["id"]?>"><i class="fa fa-trash"></i></a></td>
										 </tr>
									<?php 
									}
									?>
