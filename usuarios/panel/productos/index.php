  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="active">
              <a href="index.php" class="btn">Pproductos</a>
            </li>
            <li class="dropdown">
    ...
    <div class="container" id="main">
        ...
        <div class="row">
          <div class="col-md-12">
             <fieldset>
              <legend>Listado de Pproductos</legend>
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    <?php
                      ...
                      $pproducto = new Kawschool\Pproducto;
                      $info_pproducto = $pproducto->mostrar();

                    
                      $cantidad = count($info_pproducto);
                      if($cantidad > 0){
                        $c=0;
                      for($x =0; $x < $cantidad; $x++){
                        $c++;
                        $item = $info_pproducto[$x];
                    ?>
